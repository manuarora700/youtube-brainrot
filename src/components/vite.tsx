...
export const Vite = () => {
  return (
    <div className="h-100 w-120 flex items-center bg-neutral-950 rounded-lg border border-neutral-700">
      <LeftLines />
      <Bolt />
      <RightLines />
    </div>
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.7" stop-color="white" stop-opacity="0.2"></stop>
    ...
    >
      ...
      <defs>
        ...
        <radialGradient
          ...
          gradientTransform="translate(79.4533 62.3511) rotate(80.2589) scale(89.4759 88.4248)"
        >
          <stop offset="0" stop-color="#FFDD35"></stop>
          <stop offset="1" stop-color="#FFA800"></stop>
        </radialGradient>
      </defs>
    </svg>
...
const RightLines = () => {
  return (
    ...
    >
      ...
      <path
        d="M8.0866e-07 19.5L105.194 18.377C118.843 18.377 132.465 17.076 145.909 14.4887L216 1"
        stroke="url(#last-line-glow-right)"
      ></path>

      <defs>
        <motion.linearGradient
          id="last-line-glow-right"
          gradientUnits="userSpaceOnUse"
          initial={{
            x1: "0%",
            x2: "-10%",
