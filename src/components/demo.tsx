...
export const Content = () => {
    return (
        <div className="relative z-10 flex max-w-2xl flex-col items-center text-center pb-32">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-[#1A1A1A] sm:text-lg">
                ...
                brief written on the walk back. The reply ready before your hand reached
                the keyboard.
            </p>
...
export const HeroAnimation = () => {
    return (
        <div className="absolute inset-0 pointer-events-none overflow-hidden ">
            <div className="absolute left-0 top-1/2 w-[min(58vw,900px)] overflow-hidden -translate-y-[45%]">
                ...
                >
                    ...
                    <text x="0" className="text-base">
                        <textPath id="marquee-test-first"
                            href="#first-curve"
            ...
            <div className="absolute top-24 -right-32 w-[min(62vw,780px)]">

                <svg className="h-auto w-[1200px] scale-130"
